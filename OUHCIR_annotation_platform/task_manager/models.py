...
class TaskAnnotation(models.Model):
    ...
    # user intent
    specificity = models.IntegerField(default=-1, null=True, blank=True)  # 0 ==> 4, broad ==> clear
    trigger = models.IntegerField(default=-1, null=True, blank=True)  # 0 ==> 4, interest-driven ==> task-driven
    # expertise = models.IntegerField(default=-1, null=True, blank=True)  # 0 ==> 4, unfamiliar ==> familiar

    # search scenario
    task_condition = models.IntegerField(default=-1, null=True, blank=True)
    task_response = models.CharField(max_length=10000, null=True, blank=True)
    time_condition = models.IntegerField(default=-1, null=True, blank=True)  # 0 ==> 4, relax ==> tense
    position_condition = models.IntegerField(default=-1, null=True, blank=True)  # 0 ==> 4, quiet ==> noisy

    # search task experience
    useful_information_task = models.IntegerField(default=-1, null=True, blank=True)
    effort_task = models.IntegerField(default=-1, null=True, blank=True)
    satisfaction_task = models.IntegerField(default=-1, null=True, blank=True)
    recommendation_task = models.IntegerField(default=-1, null=True, blank=True)
    # information_difficulty = models.IntegerField(default=-1, null=True, blank=True)
    # success = models.IntegerField(default=-1, null=True, blank=True)
...
class PreSurvey(models.Model):
    ...
    task_condition = models.IntegerField(default=-1, null=True, blank=True)
    familarity = models.IntegerField(default=-1, null=True, blank=True)
    pre_experience = models.IntegerField(default=-1, null=True, blank=True)
    difficulty = models.IntegerField(default=-1, null=True, blank=True)
...
class PageLog(models.Model):
    ...
    html = models.CharField(max_length=10000000, null=True, blank=True)
    start_timestamp = models.IntegerField(null=True, blank=True)
    end_timestamp = models.IntegerField(null=True, blank=True)
    ...
    bookmark = models.IntegerField(default=-1, null=True, blank=True)
    # page_docs = models.CharField(max_length=10000000, null=True, blank=True)
