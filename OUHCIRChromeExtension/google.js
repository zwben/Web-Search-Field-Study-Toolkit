if (debug) console.log("Google Main Page is Loaded!");
...
mPage.init_content = function () {
    mPage.query = document.getElementsByName("q")[0].value;
    mPage.page_id = parseInt($("td.YyVfkd").text());
...
mPage.update = function () {
    ...
    $("div.MUFPAc a").each(function (id, element) {
    ...
    $("div.yuRUbf").each(function (id, element) {
    ...
    $("a").each(function (id, element) {
        if ($(element).attr("bindclick") == undefined) {
            ...
            $(element).click(function (event) {
                ...
                var rs = getElementsByClassName("y6Uyqe")[0];
